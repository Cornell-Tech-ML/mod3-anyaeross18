...
class TensorData:
    ...
    def index(self, index: Union[int, UserIndex]) -> int:
        """Convert a multidimensional index or a single integer index to a single-dimensional position in storage.

        Args:
        ----
            index : Union[int, UserIndex]
                The index to convert. Can be a single integer or a sequence of integers.

        Returns:
        -------
            int
                The single-dimensional position in storage.
